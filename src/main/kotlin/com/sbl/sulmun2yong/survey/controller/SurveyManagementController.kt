...
class SurveyManagementController(
    ...
    @PostMapping
    override fun createSurvey() = ResponseEntity.ok(surveyManagementService.createSurvey())
    ...
    ) = ResponseEntity.ok(surveyManagementService.saveSurvey(surveySaveRequest))
}
